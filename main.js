...
*/
(function () {
  "use strict"; // Shortcut to get elements
  ...
  var displayNum = function displayNum() {
    ...
    theNum = parseFloat(theNum); // Perform operation
    ...
    equals.setAttribute("data-result", resultNum); // Now reset oldNum & keep result
  ...
  equals.onclick = displayNum; // Add click event to clear button

  el("#clear").onclick = clearAll; // Add click event to reset button
